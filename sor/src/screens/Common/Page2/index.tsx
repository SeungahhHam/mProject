    ...
    <Container style={{marginTop:58,}}>
      <ScrollView style={{flexDirection:'column',height:'100%',backgroundColor:'#ffffff'}}>
        ...
        <View style={{flexDirection:'row',marginBottom:15,paddingHorizontal:15}}>
          ...
          <Text style={{flex:1,lineHeight:40,justifyContent:'center',alignItems:'center',textAlign:'center',backgroundColor:'#2586ee',color:'#fff',borderRadius:5,fontSize:15,}}>모집</Text>
        ...
        <View style={{flexDirection:'row',marginBottom:15,paddingHorizontal:15,marginHorizontal:-5,}}>
          <Text style={{marginHorizontal:5,paddingHorizontal:8,lineHeight:40,flex:1,justifyContent:'center',alignItems:'center',borderRadius:5,borderWidth:1,borderColor:'#dfdfdf'}}>성별 ▼</Text>
          <Text style={{marginHorizontal:5,paddingHorizontal:8,lineHeight:40,flex:1,justifyContent:'center',alignItems:'center',borderRadius:5,borderWidth:1,borderColor:'#dfdfdf'}}>난이도 ▼</Text>
          <Text style={{marginHorizontal:5,paddingHorizontal:8,lineHeight:40,flex:1,justifyContent:'center',alignItems:'center',borderRadius:5,borderWidth:1,borderColor:'#dfdfdf'}}>위치 ▼</Text>
        </View>
          ...
          <View style={{flexDirection:'row',alignItems:'center'}}>
            ...
            <View style={{flexDirection:'column'}}>
              <View style={{flexDirection:'row',marginBottom:8,alignItems:'center'}}>
                <Text style={{fontSize:14,color:'#111'}}>모집중</Text>
                <Text style={{marginLeft:10,fontSize:12,color:'#999'}}>(1명)</Text>
              </View>
              <View style={{flexDirection:'row',alignItems:'center'}}>
                <Text style={{fontSize:14,color:'#333'}}>성별, 모집인원, 산, 등산시간</Text>
              </View>
            </View>
          </View>
        </View>
        <View style={{flexShrink:0,marginVertical:15,alignItems:'center',justifyContent:'center'}}>
          <Text style={{borderRadius:5,backgroundColor:'#555',fontSize:15,color:'#fff',paddingHorizontal:16,lineHeight:32}}>모집 글쓰기</Text>
        </View>
      </ScrollView>
    </Container>
  );
