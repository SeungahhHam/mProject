...
const Indicators5 = ({ navigation }: Props) => {
        ...
        <TopContainer>
          <TopText style={{alignItems:'center',justifyContent:'center'}}>
            <TopTit style={{flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
              <Text style={{fontSize:30,fontWeight:'bold',color:'#191919',}}>RAI</Text>  
            ...
            <TopSub style={{alignItems:'center',justifyContent:'center'}}>
              <Text style={{fontSize:15,color:'#191919',}}>증권 리서치 관심 지수</Text>
            </TopSub>
            <TopTxt style={{marginTop:20,alignItems:'center',justifyContent:'center'}}>
              <Text style={{textAlign:'center',fontSize:16,color:'#191919',}}>특정 종목 및 증권 리서치에 대한 관심지수를 {"\n"} 기간별로 비교합니다.</Text>
            </TopTxt>
          </TopText>
        </TopContainer>
        <IndiContainer>
