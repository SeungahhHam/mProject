  ...
  return (
    <IndicatorsContainer style={{ flex: 1, paddingTop:48, }}>
      <ScrollView style={{ flex: 1 }} >
        <TopContainer>
          <TopText style={{alignItems:'center',justifyContent:'center'}}>
            ...
            <TopSub style={{alignItems:'center',justifyContent:'center'}}>
              <Text style={{fontSize:15,color:'#191919',}}>언론 노출 지수22222222222222222</Text>
            </TopSub>
            <TopTxt style={{marginTop:20,alignItems:'center',justifyContent:'center'}}>
              <Text style={{textAlign:'center',fontSize:16,color:'#191919',}}>언론에 노출된 특정 기업에 대한 {"\n"} 종목지수를 기간별로 비교합니다.</Text>
            </TopTxt>
          </TopText>
        </TopContainer>
        <IndiContainer>
            ...
            <IndiBot>
              ...
              <IndiBtn style={{marginHorizontal:-6}}>
                <View style={{padding:5,flexDirection:'row',alignItems:'center',marginHorizontal:6,borderWidth:1,borderColor:'#dbdbdb',borderRadius:6,paddingHorizontal:10,backgroundColor:'#fff'}}>
                  <Text style={{lineHeight:24,fontSize:13,fontWeight:'bold',color:'#6524FF'}}>상위 [100]개 종목 추출</Text>
                </View>
                <View style={{flex:1,padding:5,flexDirection:'row',justifyContent:'center',alignItems:'center',marginHorizontal:6,borderWidth:1,borderColor:'#dbdbdb',borderRadius:6,paddingHorizontal:10,backgroundColor:'#fff'}}>
                  <Text style={{lineHeight:24,fontSize:13,color:'#191919'}}>1일</Text>
                  <Text style={{marginLeft:6,lineHeight:24,fontSize:13,color:'#191919'}}>1주</Text>
                  <Text style={{marginLeft:6,lineHeight:24,fontSize:13,color:'#191919'}}>1개월</Text>
                  <Text style={{marginLeft:6,lineHeight:24,fontSize:13,color:'#191919'}}>3개월</Text>
                  <Text style={{marginLeft:6,lineHeight:24,fontSize:13,color:'#191919'}}>1년</Text>
                </View>
              </IndiBtn>
        ...
        <CautBox>
          <Text>* 전일 기준 수치는 하단 <Text style={{fontWeight:'bold',color:'#C6C6E0'}}>회색</Text>으로 표시</Text>
          <Text>* 시간 범위 클릭시 EPD의 데이터 수집 기준 기간을 변화시키면서 확인할 수 있음</Text>
          <Text>* 특정 종목 검색 시 순위와 수치 확인 가능</Text>
        </CautBox>
