...
const ReportDesc = Styled.View`
  ...
  flex-direction:row;
`;
const SentimentBox = Styled.View`
  flex-direction:column;
  margin:20px 0;
  padding: 0 20px;
`;
const SentimentTitle = Styled.View`
`;
const SentimentCont = Styled.View`
  padding:20px;
  borderRadius:10px;
  background-color:#F8F8FA
`;
...
const Indicators3 = ({ navigation }: Props) => {
    ...
    <IndicatorsContainer style={{ flex: 1, paddingTop:48, }}>
      <ScrollView style={{ flex: 1 }} >
        <TopContainer>
          <TopText style={{alignItems:'center',justifyContent:'center'}}>
            <TopTit style={{flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
              <Text style={{fontSize:30,fontWeight:'bold',color:'#191919',}}>EWD</Text>  
            ...
            <TopSub style={{alignItems:'center',justifyContent:'center'}}>
              <Text style={{fontSize:15,color:'#191919',}}>언론 감성 지수</Text>
            </TopSub>
            <TopTxt style={{marginTop:20,alignItems:'center',justifyContent:'center'}}>
              <Text style={{textAlign:'center',fontSize:16,color:'#191919',}}>언론의 특정 기업에 대한 감성지수를 {"\n"} 기간별로 비교합니다.</Text>
            </TopTxt>
          </TopText>
        </TopContainer>
        <IndiContainer>
          <IndiBox>
            <IndiTop style={{flexDirection:'row',alignItems:'center',padding:10,}}>
              <Text style={{lineHeight:40,fontSize:16,fontWeight:'bold',color:'#191919'}}>EWD 언론 노출 지수 </Text>
        ...
        <RecomBox style={{paddingBottom:60,borderBottomWidth:8,borderColor:'#EFEFF5'}}>
          <Text style={{flex:1}}>1년간 가장 많이 노출된 {'\n'}‘현대차’ 1년 전에 샀다면?</Text>
          <View style={{flex:1,flexDirection:'column',alignItems:'center'}}>
            <Text style={{textAlign:'center'}}>단순 보유 수익률 : {'\n'}<Text style={{fontWeight:'bold',color:'#FF2470'}}>22.52%</Text></Text>
            <Text style={{marginTop:15,textAlign:'center'}}>기술 매매 수익률 : {'\n'}<Text style={{fontWeight:'bold',color:'#FF2470'}}>31.27%</Text></Text>
          </View>
        </RecomBox>
        <IndiContainer style={{paddingTop:60}}>
          <IndiBox>
            <IndiTop style={{flexDirection:'row',alignItems:'center',padding:10,}}>
              <Text style={{lineHeight:40,fontSize:16,fontWeight:'bold',color:'#191919'}}>스포트라이트 </Text>
              <View style={{flexDirection:'row',alignItems:'center'}}>
                <Image resizeMode='contain' style={{width:100,height:20,}}  source={require('~/Assets/Images/Tab1/asend_searchbox.png')} />
                <Image resizeMode='contain' style={{width:20,height:20,}}  source={require('~/Assets/Images/Tab1/asend_search.png')} />
              </View>
            ...
            <IndiBot>
              ...
              <IndiBtn style={{height:30}}>
                ...
                <View style={{flex:1,flexDirection:'row',justifyContent:'center',alignItems:'center',marginHorizontal:6,borderWidth:1,borderColor:'#dbdbdb',borderRadius:6,backgroundColor:'#fff'}}>
                  <Text style={{flex:1,paddingHorizontal:3,lineHeight:28,fontSize:11,color:'#191919',textAlign:'center'}}>1주~1개월</Text>
                  <Text style={{flex:1,paddingHorizontal:3,lineHeight:28,fontSize:11,color:'#191919',borderLeftWidth:1,borderColor:'#dbdbdb',textAlign:'center'}}>1개월~3개월</Text>
                  <Text style={{flex:1,paddingHorizontal:3,lineHeight:28,fontSize:11,color:'#191919',borderLeftWidth:1,borderColor:'#dbdbdb',textAlign:'center'}}>3개월~1년</Text>
                </View>
              </IndiBtn>
            </IndiBot>            
          </IndiBox>
        ...
        <CautBox>
          <Text style={{fontSize:12}}>* 스포트라이트 지수는 각 지표가 최근 얼마나 더 급상승 했는지를 바탕으로 보여주는 지수입니다. 보다 단기적인 투자 인사이트에 도움이 될 것입니다.</Text>
        </CautBox>
        <RankContainer style={{marginHorizontal:-6,paddingBottom:60,borderBottomWidth:8,borderColor:'#EFEFF5'}}>
          <Rankdesc style={{marginHorizontal:6,borderRadius:6,borderWidth:1,borderColor:'#dbdbdb',overflow:'hidden'}}>
            <Text style={{flexDirection:'row',padding:10,}}>지난 달 EWD{'\n'}스포트라이트 수익률 #1</Text>
            <Text style={{flexDirection:'row',padding:10,textAlign:'center',alignItems:'center',fontSize:15,fontWeight:'bold',color:'#fff',backgroundColor:'#472C86'}}>상신전자(15%)</Text>
          </Rankdesc>
          <Rankdesc style={{marginHorizontal:6,borderRadius:6,borderWidth:1,borderColor:'#dbdbdb',overflow:'hidden'}}>
            <Text style={{flexDirection:'row',padding:10,}}>지난 달 EWD{'\n'}스포트라이트 수익률 #2</Text>
        ...
        <SentimentBox style={{paddingBottom:60,borderBottomWidth:8,borderColor:'#EFEFF5'}}>
          <SentimentTitle style={{flexDirection:'row',alignItems:'center',marginBottom:15,}}>
            <Text style={{lineHeight:40,fontSize:20,fontWeight:'bold',color:'#191919'}}>시장 감성지수</Text>
          </SentimentTitle>
          <SentimentCont>
            <Text style={{fontSize:16,color:"#191919"}}>오늘의 시장에 대한 감성은 <Text style={{fontWeight:'bold'}}>“적정긍정”</Text> 입니다.{'\n'}<Text style={{fontSize:13,}}>(매우부정, 적정부정, 적정긍정, 매우긍정)</Text></Text>
            <View style={{marginTop:30,}}>
              <Text style={{marginBottom:10,fontSize:18,fontWeight:'bold',color:'#191919'}}>감성 대장주</Text>
              <View>
                <Text style={{fontSize:15,color:'#191919'}}>1. 삼성바이오로직스</Text>
                <Text style={{fontSize:15,color:'#191919'}}>2. 삼성전자</Text>
                <Text style={{fontSize:15,color:'#191919'}}>3. 삼성카드</Text>
              </View>
            </View>
            <View style={{marginTop:30,flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
              <Text style={{marginBottom:6,width:'100%',fontSize:13,textAlign:'right'}}>(시장 감성의 영향력 순위)</Text>
              <View style={{width:'100%',borderRadius:6,borderWidth:1,borderColor:'#dbdbdb',padding:10,backgroundColor:'#ffffff'}}>
                <View style={{marginBottom:6}}>
                  <Text style={{fontSize:12}}>오늘 : <Text style={{color:'#6524FF'}}>+ 17</Text></Text>
                  <Text style={{fontSize:10}}>(-20 ~ +20)</Text>
                </View>
                <Image resizeMode='contain' style={{width:'100%'}}  source={require('~/Assets/Images/Tab1/asend_feargreed.png')}/>
              </View>
            </View>
            <View style={{marginTop:10,borderRadius:6,borderWidth:1,borderColor:'#dbdbdb',paddingVertical:6,paddingHorizontal:10,backgroundColor:'#ffffff',flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
              <Text style={{fontSize:15,fontWeight:'500',color:'#191919'}}>시장 감성에 따른 투자 전략은?</Text>
              <Image resizeMode='contain' style={{width:16}}  source={require('~/Assets/Images/Tab1/asend_act.png')}/>
            </View>
          </SentimentCont>
        </SentimentBox>
        <ReportBox>
